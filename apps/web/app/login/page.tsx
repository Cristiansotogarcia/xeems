  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ color: '#f97316', fontWeight: 700, letterSpacing: '0.18em', textTransform: 'uppercase' }}>Owner / Admin Login</div>
        ...
        <input
          ...
          style={{ padding: 14, borderRadius: 14, border: '1px solid #c6d5e3', background: '#f9fbfd', color: '#10233d' }}
        />
        <div style={{ color: '#355372', fontSize: 14 }}>Admins use this web portal. Employees use the XEEMS desktop or mobile app.</div>
        <button
          disabled={loading}
